...
contract RockPaperScissors {
    ...
    function judge() public view returns (string memory) {
        ...
        require(hands[player1] == Hand.Rock || hands[player1] == Hand.Paper || hands[player1] == Hand.Scissors);
        require(hands[player2] == Hand.Rock || hands[player2] == Hand.Paper || hands[player2] == Hand.Scissors);
